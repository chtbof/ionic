...
#### 修改 config.xml 檔案內容, 如下, 再重建apk即可.

```
<?xml version="1.0" encoding="UTF-8" standalone="yes"?>
<widget id="com.ionicframework.myapp439804" version="0.0.1" xmlns="http://www.w3.org/ns/widgets" xmlns:cdv="http://cordova.apache.org/ns/1.0">
  <!--~~~~~~~~~~~~~~~~~~~~~~~~-->
  <!-- 以下內容修改           -->
  <!--~~~~~~~~~~~~~~~~~~~~~~~~-->  
  <name>遇見文青</name>
  <description>一個北商程式設計課程的測試App</description>
  <author email="tomlin@ntub.edu.tw" href="http://www.ntub.edu.tw/">北商資管系(科)</author>
  <!--~~~~~~~~~~~~~~~~~~~~~~~~-->
